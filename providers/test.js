...
function buildTitle(meta, res, lang, format, size, extra, season, episode) {
  ...
  const line3 = `🎞️ ${format.toUpperCase()} | ⏱️ ${meta.duration} | 🔊 ${meta.audioCodec}`;
      ...
      if (masterPlaylist) {
        ...
        try {
          ...
          if (playlistResponse.ok) {
            ...
            // FIX 1: Better multi-audio engine language detection
        ...
        // FIX 3: Fixed format logic checking URL structure & query details 
