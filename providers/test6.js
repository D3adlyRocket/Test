...
// 1. Settings Layout configuration for Audio Preferences (Updated for Latino)
...
const PROVIDER_NAME = "PrimerLatino";
// Updated with your requested PrimerLatino premium endpoint base
const MOVIEBOX_BASE = "https://www.primerlatino.com/premium/NBK8X";
...
async function getStreams(tmdbId, mediaType, season, episode) {
  ...
  try {
    ...
    // 3. Fetch the stream data from the PrimerLatino endpoint
    ...
    // 4. Map language tags and filter using your Latino configurations
    data.streams.forEach(s => {
      ...
      // Matches latino, lat, spanish, esp, dual, or multi-audio keywords
