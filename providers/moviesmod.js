...
/**
 * Directly parses internal m4uplay player pages to recover raw streaming playlists
 */
async function extractDirectM3u8(playerUrl) {
  try {
    ...
    console.error("[Movies4u] Direct player parsing failed:", e);
  }
  return null;
}
