...
async function getStreams(tmdbId, mediaType, season, episode) {
    ...
    : `${MOVIEBOX_BASE}/source=v3|lang=en|res=all|uid=user_utscfumv/stream/movie/${imdbId}.json`;
        

const hindiUrl = isSeries
    ? `${MOVIEBOX_BASE}/source=v3|lang=hi|res=all/stream/series/${imdbId}:${season || 1}:${episode || 1}.json`
    : `${MOVIEBOX_BASE}/source=v3|lang=hi|res=all|uid=user_utscfumv/stream/movie/${imdbId}.json`;
